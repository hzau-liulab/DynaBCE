    ...
    def _atom_atom_vector(self):
        ...
        for atom1 in atoms:
            atom_atom_vector[atom1] = dict(map(lambda x: (x,
                                                          np.array(self.coord['_'.join(atom1.split('_')[:-1])][
                                                                       atom1.split('_')[-1]], dtype=float) - np.array(
                                                              self.coord['_'.join(x.split('_')[:-1])][x.split('_')[-1]],
                                                              dtype=float)), atoms))
...
def get_str_feat(pdbfile, pdb_fuc, pc):
    ...
    # np.savetxt(f'/home/yyShen/Epitope_project/GraphBepi/feature/TP_TR2/{pc}-tp.txt', tp, fmt='%s')
    # np.savetxt(f'/home/yyShen/Epitope_project/GraphBepi/feature/SA_TR2/{pc}-sa.txt', rasa, fmt='%s')
    # np.savetxt(f'/home/yyShen/Epitope_project/GraphBepi/feature/RC_TR2/{pc}-rc.txt', rc, fmt='%s')
    # np.savetxt(f'/home/yyShen/Epitope_project/GraphBepi/feature/MFD_TR2/{pc}-mfd.txt', mfd, fmt='%s')
    # np.savetxt(f'/home/yyShen/Epitope_project/GraphBepi/Template/feature/CV/{pc}-cv.txt', cv, fmt='%s')
    # np.savetxt(f'/home/yyShen/Epitope_project/GraphBepi/feature/LN_TR2/{pc}-ln.txt', ln, fmt='%s')
    # np.savetxt(f'/home/yyShen/Epitope_project/GraphBepi/feature/GE_TR2/{pc}-ghe.txt', ge, fmt='%s')
    # return res_distmap
