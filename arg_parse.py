...
def arg_parse():
    ...
    parser.add_argument("--dssp", type=str, default='./software/dssp', help="dssp software")
    parser.add_argument("--psaia", type=str, default='./software/psaia', help="psaia software")
